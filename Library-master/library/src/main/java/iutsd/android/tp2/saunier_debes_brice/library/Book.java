 ...
 * de base d'un livre.
 * On implemente l'interface serializable pour pouvoir envoyé des objets de la classe Book dans des intents
 */
public class Book
  ...
  /**
   * Getter pour recuperer l'id du livre
   *
   * @return bookId
   */
  ...
  /**
   * Getter pour recuperer le nom du livre
   *
   * @return bookName
   */
  ...
  /**
   * Setter pour modifier le nom du livre
   *
   * @param bookName
   */
  ...
  /**
   * Getter pour recuperer l'auteur du livre
   *
   * @return bookAuthor
   */
  ...
  /**
   *  Setter pour modifier l'auteur du livre
   *
   * @param author
   */
  ...
  /**
   * Getter pour recuperer la description
   *
  ...
  /**
   * Setter pour modifier la description du livre
   * 
   * @param description
   */
  ...
  /**
   * Getter pour recuperer le chemin de l'image du livre
   *
   * @return bookImageUri
   */
  ...
  /**
   * Setter pour modifier le chemin de l'image du livre
   * 
   * @param imageUri
   */
  ...
  /**
   * Comparateur classique pour tester si l'id du livre (this) est le même que le livre donnée en paramètre
   *
   * @param obj
   *
   * @return
  ...
  public static List<Book> GET_TEST_LIST() {
    Book[] books =
        new Book[] { new Book(1, "La rencontre: l’histoire véridique...", "Allan W. Eckert",
            "Texte long Original Rencontre"),
                     new Book(2, "Moi, un lemming", "Arkin Alan", "Texte long Philo"),
                     new Book(3, "Mama délire, sorcière d’Afrique", "Arthur Claire",
                         "Sorcière Humour"),
                     new Book(4, "Sales petits voleurs Ludo n° 4", "Bailly, Mathy,Lapière",
                         "BD. Mélange fiction et réalité"),
                     new Book(5, "Pas touche à mon copain", "Barbeau Philippe", "Racket"),
                     new Book(6, "Rouge Matou", "Battut Eric",
                         "Amitié  Album Personnification animaux"),
                     new Book(7, "C’est quoi ta collec’", "Ben Kemoun Hubert", "Amitié"),
                     new Book(8, "La citrouille olympique", "Ben Kemoun Hubert",
                         "Moquerie/ enfant obèse"),
                     new Book(9, "Terriblement vert", "Ben Kemoun Hubert", "Récits parallèles"),
                     new Book(10, "Le serpent à fenêtre", "Bobe Françoise",
                         "Album Structure Référence contes"),
                     new Book(11, "Le fil à retordre", "Bourgeyx Claude",
                         "Détournement de mots et de concepts Nouvelles"),
                     new Book(12, "Avril et la poison", "Branford Henrietta",
                         "Vrai roman d’aventure"),
                     new Book(13, "2 graines de cacao", "Brisou Pellen Evelyne",
                         "Texte long Aventure "),
                     new Book(14, "Mon extra-terrestre préféré", "Brisou-Pellen Evelyne",
                         "Science Fiction Extra-terrestres"),
                     new Book(15, "La montagne noire", "Brouillet Christine",
                         "Récit d’aventure dans la forêt québécoise"),
                     new Book(16, "Les collégiens mènent l’enquête", "Brouillet Christine",
                         "Policier  Langue"),
                     new Book(17, "Le tunnel", "Browne Anthony", "Album Affection"),
                     new Book(18, "Une histoire à 4 voix", "Browne Anthony", "Points de vue"),
                     new Book(19, "Champions, les rollers", "Cahour Chantal",
                         "Récits courts de petites aventures"),
                     ...
                     new Book(25, "Les machines de M. Albert", "Choux Nathalie",
                         "Affection Original Inventions Album"),
                     new Book(26, "Little Lou", "Claverie Jean", "Musique USA"),
                     new Book(27, "Ma meilleure copine", "Clément Claire", "Amitié Journal"),
                     new Book(28, "Le temps des cerises", "Clément J. Baptiste",
                         "La Commune Historique Album"),
                     new Book(29, "Meurtre au pays des peluches", "Cohen-Scali Sarah", "Enquête"),
                     new Book(30, "Un bisou sorcière", "Cohen-Scali Sarah",
                         "Sorcière Affection Album") };
